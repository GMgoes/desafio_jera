		...
		<div class="position-absolute top-50 start-50 translate-middle">
			<form method="POST" action="ValidarCredenciais.php">
		        <div class="form-group">
			        ...
			        <input type="text" class="form-control"name="email" style="opacity: 0.8" required>
			    </div>
			    <div class="form-group mt-2">
			        <label for="validationServer02"><h5 style="color:	#8B4513;">Senha</h5></label>
			        <input type="password" class="form-control" name="password" style="opacity: 0.8" required>
			    </div>
