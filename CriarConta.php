    ...
    <body id="background">
        ...
        <?php session_start(); 
            ...
            <div class="alert alert-danger alert-dismissible fade show" role="alert">
                <strong>Erro! E-mail já cadastrado.</strong>
                ...
                <div id ="form-criar-conta" class="col-2">
                    <form method="POST" action="SalvarCadastro.php">
                        <div class="form-group">
                            <label><h5 style="color:#32CD32;">Nome</h5></label>
                        ...
                        <div class="form-group">
                            <label><h5 style="color:#32CD32;">Data de Nascimento</h5></label>
                            <input type="date" class="form-control" name="nascimento" required>
                        </div>
                        <div class="d-grid gap-2 mt-2">
                            <button type="submit" class="btn btn-outline-success mt-5">Cadastrar</button>
                            <a class="btn btn-outline-primary mt-2" href="Index.php">Voltar</a>  
                        </div>
                    </form>
                </div>
            </div>
