                    ...
                    <?php    
                            if($resultado->backdrop_path == null){
                                $formato_imagem = "moldura.jpg";
                                    ...
                                    $formato_imagem = "https://image.tmdb.org/t/p/w300/".$resultado->backdrop_path;    
                                }                                         
                    ?>
                        <form action = "VisualizarFilme.php" method = "POST">
                            <input type="hidden" name="id_filme" value="<?php echo ($resultado->movie_id) ?>">
                            <button type ="submit" style ="border:none;"><img src="<?php echo $formato_imagem ?>" class="img-fluid"></button>
                        </form>         
